      ...
      <head>
        ...
        <style>
          @font-face {
            ...
            font-weight: 400;
            font-style: normal;
            src: url(https://assets.gusto.com/static/fonts/proxima-nova/proximanova-regular-webfont.eot#iefix) format("embedded-opentype"), url(https://assets.gusto.com/static/fonts/proxima-nova/proximanova-regular-webfont.woff2) format("woff2"), url(https://assets.gusto.com/static/fonts/proxima-nova/proximanova-regular-webfont.woff) format("woff")
          }
          @font-face {
            font-family: Arial;
            font-weight: 600;
                    ...
                    <table id="templateHeaderLogo" style="border-spacing: 20px; width: 100%; border-collapse: collapse;" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <div id="mail-text" style="text-align: left; margin-top: 30px; margin-bottom: 30px;">
                            <p>Hi """ + str(args[0][0]) + """,</p>
                            <p>Thank you for signing up for <b>Daily Salary</b>. You're almost done!</p>
                        </div>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td align="center" valign="top" class="template-section-container" style="border-collapse: collapse; padding-top: 0; padding-bottom: 0; padding-left: 10px; padding-right: 10px;">
                    <table id="templateBody" style="width: 100%; border-collapse: separate; border-spacing: 0;" width="100%" cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tr>
                        <td class="template-header-logo-body" align="center" valign="top" style="border-collapse: collapse; padding-top: 20px; padding-right: 0; padding-bottom: 5px; padding-left: 0;">
                          <div style="font-size: 20px; font-weight: normal; color:#b8860b; padding-bottom: 0px;">DAILY <strong>SALARY</strong></div>
                        </td>
                      </tr>
                            <tr>
                              <td style="border-collapse: collapse; padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0;">
                                <div class="ob-template-header" style="margin-bottom: 15px; margin-top: 10px;">
                                  <div style="padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0; font-style: normal; font-weight: bold; letter-spacing: normal; color: #111; font-size: 20px; line-height: 24px; max-width: 360px; margin-top: 0; margin-right: auto; margin-bottom: 10px; margin-left: auto; text-align: center;" align="center">Verify your Email Address</div>
                                  <div style="padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0; font-style: normal; letter-spacing: normal; color: #111; font-size: 16px; line-height: 24px; max-width: 360px; margin-top: 0; margin-right: auto; margin-bottom: 0px; margin-left: auto; text-align: center;" align="center">Please confirm your email address by clicking the button below.</div>
                                </div>
                                    <div class="ob-template-btn-wrap" style="padding-top: 0px; padding-right: 0; padding-bottom: 10px; padding-left: 0;">
                                    <div style="margin-top: 5px; margin-right: 0; margin-bottom: 30px; margin-left: 0; display: block; text-align: center;" align="center">
                                      <a href="https://""" + str(args[0][4]) + """/verify-email/?mail_token=""" + str(args[0][1]) + """&id=""" + str(args[0][3]) + """" style="font-weight:bold;font-size:16px;text-decoration:underline;display:inline-block;margin:0;" class="btn btn-primary" target="_blank">
                        ...
                        <td class="template-footer-content" align="center" valign="top" style="border-collapse: collapse; padding-right: 0; padding-left: 0; padding-top: 30px; padding-bottom: 35px;">
                          ...
                          <p style="font-weight: 400; line-height: 1.6em; font-size: 14px; margin-bottom: 0; margin-top: 0; margin-right: 0; margin-left: 0;"><small>You received this email because you have registered on Daily Salary.</small></p>
                              <p style="font-family: Arial; text-align: center; font-size: 11px;">
                                <a href="https://instasalary.app/unsubscribe/?unsubscribe_token=""" + str(args[0][2]) + """">Unsubscribe</a>
                            </p>
                        </td>
                      </tr>
                    </table>
